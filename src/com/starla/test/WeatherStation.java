...
public final class WeatherStation extends IOIOConsoleApp {
    ...
    public final double ALTITUDE = 1111.0;
    ...
    public IOIOLooper createIOIOLooper(String connectionType, Object extra) {
        return new BaseIOIOLooper() {
            ...
            public void loop() throws ConnectionLostException, InterruptedException {
                ...
                relativePressure = bmp180.mbToAtm(bmp180.seaLevel(bmp180.getPressure(temperature, BMP180.Oversampling.HIGH_RES), ALTITUDE));
